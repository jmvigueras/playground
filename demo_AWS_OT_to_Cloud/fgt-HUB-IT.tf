...
resource "aws_ec2_transit_gateway_route" "tgw_hub_it_vpc-spoke_route" {
  destination_cidr_block         = "0.0.0.0/0"
  transit_gateway_attachment_id  = module.fgt_hub_it_vpc.vpc_tgw-att_id
  transit_gateway_route_table_id = module.tgw_hub_it.rt_vpc-spoke_id
}
