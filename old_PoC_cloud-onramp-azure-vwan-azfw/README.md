# Fortigate cluster ONRAMP, VNET spokes and vHUB deployment on the Azure with Terraform
## Introduction

This is a full example of an IaC deployment of a common HUB and SPOKE topology, with a Fortigate cluster in a inspection VNET acting as SDWAN ONRAMP site and connected to VNET spokes through peering and also with a vHUB.
