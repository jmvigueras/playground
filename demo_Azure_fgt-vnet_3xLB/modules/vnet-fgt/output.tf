...
output "fgt-active-ni_ids" {
  value = {
    ...
    erc     = azurerm_network_interface.ni-active-erc.id
  }
}
...
output "fgt-passive-ni_ids" {
  value = {
    ...
    erc     = azurerm_network_interface.ni-passive-erc.id
  }
}
...
output "subnet_names" {
  value = {
    ...
    erc = azurerm_subnet.subnet-erc.name
  }
}
...
output "subnet_ids" {
  value = {
    ...
    erc = azurerm_subnet.subnet-erc.id
  }
}
